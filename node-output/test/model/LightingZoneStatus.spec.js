...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LightingZoneStatus', function() {
      beforeEach(function() {
        instance = new HomeIotApi.LightingZoneStatus();
      });

      it('should create an instance of LightingZoneStatus', function() {
        // TODO: update the code to test LightingZoneStatus
        expect(instance).to.be.a(HomeIotApi.LightingZoneStatus);
      });
