...
// #swagger.tags = ['Route to multiply two numbers']
// #swagger.description = 'Endpoint to multiply two numbers.'
...
/* #swagger.responses[400] = {
  ...
  try {
    ...
    schema: {
        type: 'object',
        properties: {
            result: { type: 'number', description: 'Result of the multiplication.' },
